...
(function() {
    ...
    var lbWindow = 'daily';
    var lbGame = 'mathwar';
    var LB_GAMES = { mathwar: { path: '/mathwar_scores.json', title: '\u2694\ufe0f Math War Leaderboard', wins: '\ud83d\udc51 Most games won' }, mathescape: { path: '/mathescape_scores.json', title: '\ud83d\udd10 Math Escape Leaderboard', wins: '\ud83c\udfc3 Most escapes' }, mathplane: { path: '/mathplane_scores.json', title: '\u2708\ufe0f Math Plane Leaderboard', wins: '\ud83c\udfc6 Perfect landings' }, mathtree: { path: '/mathtree_scores.json', title: '\ud83c\udf33 Math Tree Leaderboard', wins: '\ud83c\udf3f Trees grown' } };
    ...
    function renderLeaderboard() {
        ...
        [['mathwar', '\u2694\ufe0f Math War'], ['mathescape', '\ud83d\udd10 Math Escape'], ['mathplane', '\u2708\ufe0f Math Plane'], ['mathtree', '\ud83c\udf33 Math Tree']].forEach(function (t) {
